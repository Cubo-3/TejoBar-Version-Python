...
class EquipoController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        // Crear el equipo usando consulta SQL directa
    ...
    public function destroy(Equipo $equipo)
    {
        ...
        // Verificar si el equipo tiene torneos
    ...
    public function agregarJugador(Request $request, Equipo $equipo)
    {
        ...
        // Si se asigna como capitán, quitar capitán anterior
    ...
    public function unirse(Request $request, Equipo $equipo)
    {
        ...
        // Unirse al equipo como jugador regular
    ...
    public function crearEquipo(Request $request)
    {
        ...
        // Unirse al equipo como capitán
        $equipo->jugadores()->attach($jugadorId, [
            'esCapitan' => true
        ]);

        // Actualizar el rol del usuario en la sesión y en la base de datos
    ...
    public function eliminarEquipoCompleto(Request $request, Equipo $equipo)
    {
        ...
        // Obtener el nombre del equipo antes de eliminarlo
        $nombreEquipo = $equipo->nombreEquipo;

        // Eliminar todos los partidos del capitán
        $capitan = $jugador->persona;
        \App\Models\Partido::where('capitan', $capitan->nombre)->delete();

        // Eliminar todos los torneos del equipo
        $equipo->torneosComoEquipo1()->delete();
        $equipo->torneosComoEquipo2()->delete();

        // Eliminar todas las relaciones de jugadores con el equipo
        $equipo->jugadores()->detach();

        // Eliminar el equipo
        $equipo->delete();

        // Actualizar el rol del usuario en la base de datos y en la sesión para que sea jugador
    ...
    public function expulsarJugador(Request $request, Equipo $equipo)
    {
        ...
        // Verificar si el capitán está en el equipo
        ...
        // Expulsar al jugador del equipo
        $equipo->jugadores()->detach($jugadorId);
